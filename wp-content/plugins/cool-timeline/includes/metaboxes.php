<?php
  ...
  add_action( 'save_post_cool_timeline', 'ctl_save_meta_boxes_data', 10, 2 );
    ...
    function ctl_right_section($post, $callback){
        ...
        <a class="button button-primary" target="_blank" href="https://wordpress.org/support/view/plugin-reviews/cool-timeline">'.__('Submit Review ★★★★★','cool-timeline').'</a><br>
