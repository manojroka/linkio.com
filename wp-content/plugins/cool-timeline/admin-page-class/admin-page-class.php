  ...
  class BF_Admin_Page_Class {
    ...
    public function DisplayPage() {
      ...
      echo '<form method="post" name="'.apply_filters('apc_form_name', 'admin_page_class',$this).'" class="'.apply_filters('apc_form_class', 'admin_page_class',$this).'" id="'.apply_filters('apc_form_id', 'admin_page_class',$this).'" action="" enctype="multipart/form-data">
        ...
        echo '<h1><img style="vertical-align:middle" src="'.COOL_TIMELINE_PLUGIN_URL.'/images/cooltimeline.png"><span> '.apply_filters('admin_page_class_h2',$this->args['page_title']).'&nbsp;&nbsp;&nbsp; <small style="font-size:12px;">V '.COOL_TIMELINE_CURRENT_VERSION.'</small></span></h1>'."\n".((isset($this->args['page_header_text']))? $this->args['page_header_text'] : '').' 
        </div>'."\n".'
...
<li>Create any type of custom timeline </li>
    ...
    <img src="https://res.cloudinary.com/cooltimeline/image/upload/v1503490189/website-images/cool-timeline-demos.png"></a> <a target="_blank" href="https://1.envato.market/c/1258464/275988/4415?u=https%3A%2F%2Fcodecanyon.net%2Fitem%2Fcool-timeline-pro-wordpress-timeline-plugin%2F17046256"><img src="https://res.cloudinary.com/cooltimeline/image/upload/v1468242487/6-buy-cool-timeline_vabou4.png"></a></div>
    </div>';
