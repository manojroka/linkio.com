	...
	<div id="tve-leads-editor-replace">
		<div class="tve-symbol-container">
			<div class="tve_flt" id="tve_flt">
				...
				<div id="tve_editor" class="tve_editable thrv_symbol thrv_symbol_empty <?php echo $symbol_vars['css_class'] ?> thrv_symbol_<?php echo $symbol_id ?>" data-content="<?php echo __( "Add {$type} Content Here" ); ?>"<?php echo $extra_attr; ?>><?php echo $content; ?></div>
			</div>
		</div>
	</div>
</div>
