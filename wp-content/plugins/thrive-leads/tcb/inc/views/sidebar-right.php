...
<div id="sidebar-right">
	<div class="links">
		...
		<?php if ( tcb_editor()->has_templates_tab() ) : ?>
			<a title="<?php echo tcb_editor()->get_templates_tab_title(); ?>" href="javascript:void(0)" data-position="left" class="sidebar-item click"
			   data-fn="open_templates_picker" data-tooltip="<?php echo __( 'Change Template', 'thrive-cb' ); ?>">
