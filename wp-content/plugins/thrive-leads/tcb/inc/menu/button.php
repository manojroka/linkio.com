	...
	<div class="text-options action-group">
		...
		<div class="dropdown-content">
			...
			<div class="hide-states padding-4">
				<hr class="tcb-button-size-container-divider">
				<div class="tve-control no-space" data-key="ButtonSize" data-view="ButtonGroup"></div>
				<div class="tve-control pt-5" data-key="Align" data-view="ButtonGroup"></div>
