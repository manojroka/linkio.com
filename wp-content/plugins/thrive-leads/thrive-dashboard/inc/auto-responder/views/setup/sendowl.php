<h2 class="tvd-card-title">
    ...
    <a href="//fast.wistia.net/embed/iframe/ab8z2m3b60?popover=true" class="wistia-popover[height=450,playerColor=2bb914,width=800]"><span class="tvd-icon-play"></span></a>
</h2>
<div class="tvd-row">
