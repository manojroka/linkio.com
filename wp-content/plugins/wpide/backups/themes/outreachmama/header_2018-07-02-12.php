<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6a6963d7d6a9"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/header_2018-07-02-12.php") )  ) ){
...
<meta name="google-site-verification" content="5ThVue2MHX5y5ClQwGcJz5sPLXNKFuxZqepXOT0ZSt4" />
	...
	<link href="<?php echo get_stylesheet_directory_uri(); ?>/css/newmaster80.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/css/software9.css" rel="stylesheet" type="text/css" />
	<link href="<?php echo get_stylesheet_directory_uri(); ?>/css/main-master39.css" rel="stylesheet" type="text/css" />
	<link href="<?php echo get_stylesheet_directory_uri(); ?>/css/master58.css" rel="stylesheet" type="text/css" />
	<link href="<?php echo get_stylesheet_directory_uri(); ?>/css/media-all-in-one76.css" rel="stylesheet" type="text/css" />
