<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "e180d0b304a84fabf1c4649547ddc9c93fb3fb13d1"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/linkio-manage-backlink.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/linkio-manage-backlink_2017-12-15-06.php") )  ) ){
...
<div class="section-1">
    ...
    <?php the_field('section_4_left_tab'); ?>
    <?php the_field('left_tab_content'); ?>    
    </div>
    </div>
    <div class="right-tab">
