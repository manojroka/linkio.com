<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6abca04910aa"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/linkio-new-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/linkio-new-home_2018-07-18-11.php") )  ) ){
        ...
        <div class="row">
            ...
            <div class="video-section">
                <div class="video-container">
                    <iframe src="<?php the_field('section_1_video')?>?rel=0&amp;controls=1&amp;showinfo=0;allowscreen=fullscreen" height="274" width="489"></iframe>
                </div>    
            </div>    
