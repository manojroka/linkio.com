<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "40e1c3a3c58d01e2586aae14625c4a217d6dc6af37"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/helloworld.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/helloworld_2017-11-24-09.php") )  ) ){
...
<div id="primary" class="content-area common-inner">
    <main id="main" class="site-main" role="main">
        ...
        <div class="tab-3">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 tab-3-left">
                    <?php the_field('the_link_500'); ?>
                </div>
                
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 tab-3-right">
