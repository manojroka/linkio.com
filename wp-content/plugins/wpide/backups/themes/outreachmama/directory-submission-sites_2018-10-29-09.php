...
$(document).ready(function(){
    $('#text-2').on("click", function(){
        $(".table-of-content").css("display", "block");
        $(".table-of-content").css("height", "auto");
        $('.table-content').removeClass('animatie-io');
        $('#text-2').addClass('close-icon');
    });
      $('#text-2.close-icon').on("click", function(){
        // $(".table-of-content").css("display", "none");
        // $(".table-of-content").css("height", "0");
        // $('.table-content').adddClass('animatie-io');
        // $('#text-2').removeClass('close-icon');
        alert('hi');
    });
...
#text-2.close-icon::after {
    background-image: url('https://www.linkio.com/wp-content/uploads/2018/10/button-up.png');
    content: 'Close Chapter';
    line-height: 60px;
    top:50px;
}
...
#text-2::after {
    background-image: url('https://www.linkio.com/wp-content/uploads/2018/10/button.png');
    content: 'Expand a chapter';
    position: relative;
    width: 155px;
    height: 50px;
    display: block;
