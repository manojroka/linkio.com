<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6a8a94405770"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-tutorials.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-tutorials_2018-07-02-08.php") )  ) ){
...
get_header(); ?>
<style>
.page-template-seo-tutorials .chapter.chapter6.beginners {
    background-color: #014455;
    background-image: none;
}
.google-bot.white-color-bot.black-font h5 {
    font-size: 20px;
    color: #100d07;
...
.google-bot.purple-color {
    background-color: #0c182e;
    color: #fff !important;
}
.page-template-seo-tutorials .chapter.chapter7.beginners {
    background-color: #e8e3d9;
    background-image: none;
}
.page-template-seo-tutorials .chapter.chapter7.beginners .black-font h2 {
    color: #1a1c20;
}
.page-template-seo-tutorials .chapter.chapter7.beginners h4::after {
    background: #1a1c20;
}
.page-template-seo-tutorials .chapter.chapter7.beginners h4 {
    color: #1a1c20;
}
.page-template-seo-tutorials .chapter.chapter7.beginners .google-bot.purple-color h2 {
    color: #fff;
}
.google-bot.purple-color {
    margin-bottom: 20px;
}
.page-template-seo-tutorials .chapter.chapter7.beginners .left.content-area {
    width: 78%;
}
.page-template-seo-tutorials .chapter.chapter7.beginners .right.image {
    width: 22%;
    float: right;
    padding-top: 45px;
}
.page-template-seo-tutorials .chapter.chapter7.beginners #chapter7 {
    color: transparent;
}
.chapter.conclusion.beginners {
    background-color: #eed173;
    background-image: none;
}
.chapter.conclusion.beginners .right.image {
    padding-top: 0px;
}
</style>
