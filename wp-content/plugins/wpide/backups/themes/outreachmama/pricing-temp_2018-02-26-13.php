<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "e180d0b304a84fabf1c4649547ddc9c965aa32f22c"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/pricing-temp.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/pricing-temp_2018-02-26-13.php") )  ) ){
       ...
       <div class="ind-full">
              <?php if( have_rows('add_frequently_asked_questions') ): ?>
                <?php while ( have_rows('add_frequently_asked_questions') ) : the_row(); ?>
                    <div class="about-con indus-box col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        <div class="main-con">
                            <div class="indus-img">
