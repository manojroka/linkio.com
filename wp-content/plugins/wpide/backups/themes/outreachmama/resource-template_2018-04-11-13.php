<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "e180d0b304a84fabf1c4649547ddc9c9e11b87ca80"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/resource-template.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/resource-template_2018-04-11-13.php") )  ) ){
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
 <main id="main" class="site-main" role="main">
        <div class="full-width-resource-header">
            ...
            <img src="https://www.linkio.com/wp-content/uploads/2018/04/resources.jpg">
            
            <div class="header-inner">
            
            <div class="row-1100">
                <h2>SEO and Link Building Resources</h2>
                <h4>To Grow Your Authority and Traffic Fast</h4>
            </div>
        ...
        <div class="row-1100">
            <div class="resource-left">
                <div class="resource-half-left tags categories">
                  ...
                  <div class="resource-check"><input rel="category-three" type="radio" value="1" name="test" id="f-option3" class="all-2"> <label for="f-option3">Tools</label></div>
                  ...
                  <div class="resource-check"><input rel="category-five" type="radio" value="1" name="test" id="f-option5" class="all-2"><label for="f-option5"> Case Studies</label></div>
                  <div class="resource-check"><input rel="category-six" type="radio" value="1" name="test" id="f-option6" class="all-2"><label for="f-option6"> Learn</label></div>
                </div>
