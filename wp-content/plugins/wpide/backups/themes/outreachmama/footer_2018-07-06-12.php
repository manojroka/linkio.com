<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6ab463c4061f"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/footer_2018-07-06-12.php") )  ) ){
...
<script src="https://www.linkio.com/wp-content/themes/outreachmama/js/readmore.js"></script>
 <script>
    $('.chapter-full').readmore({speed: 2000});
  </script>
