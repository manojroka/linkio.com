<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "25c67326c4a0b48238af035723f9ac88a024fc9c18"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-webinars.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-webinars_2019-01-31-11.php") )  ) ){
        ...
        <div class="webinars-content-area">
            ...
            <div class="resource-left">
                <div class="resource-half-left tags categories">
                    <h4>Categories:</h4>
                  <div class="resource-check"><input rel="category-one" type="radio" checked  value="4" name="test" id="f-option1" class="all"><label for="f-option1"> All</label></div>
                  ...
                  <div class="resource-check"><input rel="category-three" type="radio" value="1" name="test" id="f-option3" class="all-2"> <label for="f-option3">General SEO</label></div>
                  ...
                  <div class="resource-check"><input rel="category-five" type="radio" value="1" name="test" id="f-option5" class="all-2"><label for="f-option5"> For Beginners</label></div>
                  <div class="resource-check"><input rel="category-six" type="radio" value="1" name="test" id="f-option6" class="all-2"><label for="f-option6"> Onsite Optimization</label></div>
                  <div class="resource-check"><input rel="category-six" type="radio" value="1" name="test" id="f-option7" class="all-2"><label for="f-option7"> Content Marketing</label></div>
                  <div class="resource-check"><input rel="category-six" type="radio" value="1" name="test" id="f-option8" class="all-2"><label for="f-option8"> Link Building</label></div>
                  <div class="resource-check"><input rel="category-six" type="radio" value="1" name="test" id="f-option9" class="all-2"><label for="f-option9"> Keyword Research</label></div>
                  <div class="resource-check"><input rel="category-six" type="radio" value="1" name="test" id="f-option10" class="all-2"><label for="f-option10"> Technical SEO</label></div>
                </div>
