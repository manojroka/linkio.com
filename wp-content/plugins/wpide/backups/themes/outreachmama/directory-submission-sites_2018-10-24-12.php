...
<style>
.page-template-directory-submission-sites .table-content {
    height: 60px;
    width: 100%;
}
.page-template-directory-submission-sites .table-content:not(:hover) ol li ,.page-template-directory-submission-sites .table-content:not(:hover) h2 {
    font-size: 0;
    margin: 0;
    opacity: 0;
    padding: 0;
...
.page-template-directory-submission-sites .table-content:hover ol li ,.page-template-directory-submission-sites .table-content:hover h2 {
