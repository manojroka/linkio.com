...
$(document).ready(function(){	
    ...
    $(".table-content").mouseenter(function(){
        $('.table-of-content').css('height','auto');
        $('.table-of-content').css('width','100%');
        $('.table-content').removeClass('animatie-io');
        $('.table-of-content').show(1000);
    });
    $(".table-content").mouseleave(function(){
        $('.table-of-content').hide(1000);
        $('.table-of-content').css('height','0');
        $('.table-of-content').css('width','100%');
        $('.table-content').addClass('animatie-io');
    });
});
</script>
<style>
...
.table-of-content.animatie-io::after {
