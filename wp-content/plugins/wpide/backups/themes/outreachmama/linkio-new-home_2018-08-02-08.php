<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6a4a5fe68c2d"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/linkio-new-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/linkio-new-home_2018-08-02-08.php") )  ) ){
        ...
        <div class="row">
         <div class="tabs-section">
              <ul class="nav nav-tabs">
                ...
                <li class="active on-button"><a class="tab-button-left" data-toggle="tab" href="#home"></a></li>
                <li class="off-button"><a class="tab-button-right" data-toggle="tab" data-toggle="tooltip" href="#menu1"></a></li>
