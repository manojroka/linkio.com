<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6ad0cf40089d"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-tutorials.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-tutorials_2018-06-28-09.php") )  ) ){
...
.page-template-seo-tutorials .br-content {
    margin: 30px 0px;
}
.page-template-seo-tutorials .beginners.black-font .google-bot h4 {
    font-size: 20px;
    font-weight: 300;
}

.page-template-seo-tutorials .chapter.chapter3.beginners .google-bot h4::after{
     background:transparent !important;
}
