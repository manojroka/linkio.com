<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "e180d0b304a84fabf1c4649547ddc9c9c2bcecdf41"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/helloworld.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/helloworld_2017-11-28-08.php") )  ) ){
...
<div id="primary" class="content-area common-inner">
    <main id="main" class="site-main" role="main">
        ...
        <div class="row">
            ...
            <div class="link-lists for-responsive remove-me">
            ...
            <li class="col-xs-12 col-sm-12 col-md-12 col-lg-12 link-lists-li-top">
        	            ...
        	            <?php if( have_rows('the_2018_link_500') ): ?>
                         ...
                         <ul id="fullpage" class="link-lists-500">
