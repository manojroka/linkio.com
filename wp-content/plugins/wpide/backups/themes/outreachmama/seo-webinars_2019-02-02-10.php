<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "25c67326c4a0b48238af035723f9ac885b654e5fbe"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-webinars.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-webinars_2019-02-02-10.php") )  ) ){
  ...
  <div class="resource-full-width webinars-full-width">    
    ...
    <div id="resource-right" class="resource-right ">
        <div id="Container" class="container">
          ...
          <div class="mix general-seo"  data-bound="">General SEO</div>
          <div class="mix for-beginners" data-bound="" >For Beginners</div>
          <div class="mix onsite-optimization" data-bound="" >Onsite Optimization</div>
          <div class="mix content-marketing"  data-bound="">Content Marketing</div>
          <div class="mix link-building" data-bound="" >Link Building</div>
          <div class="mix keyword-research" data-bound="" >Keyword Research</div>
          <div class="mix technical-seo" data-bound="" >Technical SEO</div>
          ...
          <?php if( have_rows('webinars_repeater') ): ?>
                     ...
                     <?php while( have_rows('webinars_repeater') ): the_row(); ?>
                        ...
                        <div class="mix ">
                        <?php the_sub_field('webinars_title')?>
...
<script>
     ...
     if($(this).is(":checked")) {
        $('.mix label').addClass("checked");
    } else {
        $('.mix label').removeClass("checked");
    }
});
