...
.container-nav-practice-mobile button {
    width: 100%;
    padding: 0px;
    line-height: 40px;
    font-size: 18px;
...
.container-nav-practice-mobile button .fa.fa-bars {
    font-size: 24px;
    line-height: 40px;
    position: relative;
    top: 3px;
...
.table-of-content.table-of-content-resp {
    height: 400px;
}
.page-template-directory-submission-sites .table-of-content ol {
    margin-left: 0px;
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <div  class="header-section">
        ...
        <div class="content-section">
            <div class="row-1055">
                <div class="container-nav-practice-mobile table-cont-resp q2w3-fixed-widget-container">
                    <li id="text-2" class="  widget widget_text " style="display: block;">
        ...
        <nav id="nav-practice-mobile" class="nav-practice-mobile" role="navigation" style="display:none;">
                ...
                <div class="table-of-content table-of-content-resp">
                    ...
                    <ol>
                        ...
                        <li class="three"><a class="ps2id __mPS2id _mPS2id-h" href="#section-lightblue">5 Dead Simple Ways to Find Hidden Directory Links and Create Explosive SEO</a></li>
