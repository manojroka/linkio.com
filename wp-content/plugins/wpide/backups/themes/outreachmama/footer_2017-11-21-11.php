<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "40e1c3a3c58d01e2586aae14625c4a217c632bd6a9"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/footer.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/footer_2017-11-21-11.php") )  ) ){
		    ...
		    <div class="footer-two">
    		    ...
    		    <div class="foot-2 footer-box">
    		        ...
    		        <ul>
    		            ...
    		            <li><a href="mail:support@link.io.com">support@linkio.com</a></li>
    		        </ul>
    		    </div>
    		    <div class="foot-3 footer-box">
    		        <h5>Visit Us</h5>
    		         <ul>
    		            ...
    		            <li><a class="youtube" href="https://www.youtube.com/channel/UCJlhr2AbF3NqvtohPN89UmQ" target="_blank">You Tube</a></li>
    		        </ul>
    		    </div>
    		    ...
    		    <div class="footer-bottom">
    		        <p>© <?php echo date("Y"); ?> Linkio. All rights reserved.</p>
    		    </div>
    		</div>
		    </div>
		    	</footer>
