<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6a087bb52f4a"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-tutorials.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-tutorials_2018-07-26-07.php") )  ) ){
...
}.page-template-seo-tutorials .chapter.chapter-download-pdf {
    float: left;
    width: 100%;
    background-color: #fff;
}
.page-template-seo-tutorials .content-left-40 {
    width: 40%;
    float: left;
}
.page-template-seo-tutorials .full-width {
    float: left;
    width: 100%;
    padding: 60px 20px;
}
.page-template-seo-tutorials .content-right-60 {
    float: left;
    width: 60%;
    padding: 0px 30px;
}
.page-template-seo-tutorials .content-right-60 h2 {
    margin-bottom: 0px !important;
}
.page-template-seo-tutorials .download-button-icon {
    color: #fff;
    font-size: 14px;
    font-weight: bold;
    padding: 8px 30px;
...
.page-template-seo-tutorials .download-button-icon:hover{
...
.cont-right .wpcf7-form-control.wpcf7-submit {
