<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "40e1c3a3c58d01e2586aae14625c4a21dafa93ab99"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/linkio-home-vtwo.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/linkio-home-vtwo_2017-11-18-11.php") )  ) ){
...
/**
 * Template Name: Linkio page Home
 *
...
<div id="primary" class="content-area common-inner">
 <main id="main" class="site-main" role="main">
    ...
    <div class="row">
        ...
        <div class="right-tab"><img src="<?php the_field('add_image_left'); ?>"></div>
    </div>
    </div>
