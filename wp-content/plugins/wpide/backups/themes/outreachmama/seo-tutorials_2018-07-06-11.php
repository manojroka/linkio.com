<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6ab463c4061f"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-tutorials.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-tutorials_2018-07-06-11.php") )  ) ){
	...
	$( document ).ready( function() {
       $('.read-more-chapter').on('click',function(e){
    	    ...
    	    if($currentClick.html()=='CLOSE CHAPTER') {
                ...
                $(this).parent().find('.read-more-chapter a').css('height','0px','background-color','#000');
    	    } else {
