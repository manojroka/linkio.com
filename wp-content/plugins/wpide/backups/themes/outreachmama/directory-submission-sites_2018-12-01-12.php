...
/*main-master5357*/
.page-template-directory-submission-sites .modal.fade.transistion-modal-in {
    display: block;
    position: fixed;
    top: 0;
    bottom: 0;
...
.page-template-directory-submission-sites .modal.fade.transistion-modal{
    opacity: 0;
    visibility: hidden;
    transition: opacity 1s linear;   
    z-index: -9 !important;
}
.table-sidebar.q2w3-fixed-widget-container {
    position: relative !important;
    height: auto !important;
}
.table-sidebar.q2w3-fixed-widget-container .widget {
