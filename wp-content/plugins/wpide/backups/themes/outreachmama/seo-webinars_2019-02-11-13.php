<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "25c67326c4a0b48238af035723f9ac88bd09467a38"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-webinars.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-webinars_2019-02-11-13.php") )  ) ){
    ...
    <div id="resource-right" class="resource-right ">
        <div id="Container" class="container">
          <div class="fail-message"><span>No items were found matching the selected filters</span></div>
                    ...
                    <?php $value = the_sub_field('category');?>
                    <script>
                        function myFunction() {
                          var str = "<?php the_sub_field('category');?>";
                          var res = str.split(",");
                         
                          document.getElementById("count-<?php echo $count;?>").className += res;
                        }
                    </script>
                         
                    <div class="mix general-seo count-<?php echo $count;?>"  data-bound="" id="count-<?php echo $count;?>">
