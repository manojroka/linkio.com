<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "25c67326c4a0b48238af035723f9ac885bb4df43e6"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-webinars.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-webinars_2019-02-12-12.php") )  ) ){
    ...
    <div class="resource-left">   
        ...
        <form class="controls" id="Filters">
          ...
          <fieldset>
            <h4>Category</h4>
            <div class="checkbox">
              <input type="checkbox" value=".General.SEO" class="filter-checkers">
              <label>General SEO</label>
            </div>
            <div class="checkbox">
              <input type="checkbox" value=".For.Beginners" class="filter-checkers">
              <label>For Beginners</label>
            </div>
            <div class="checkbox">
              <input type="checkbox" value=".Onsite.Optimization" class="filter-checkers">
              <label>Onsite Optimization</label>
            </div>
            <div class="checkbox">
              <input type="checkbox" value=".Content.Marketing" class="filter-checkers">
              <label>Content Marketing</label>
            </div>
            <div class="checkbox">
              <input type="checkbox" value=".Link.Building" class="filter-checkers">
              <label>Link Building</label>
            </div>
            <div class="checkbox">
              <input type="checkbox" value=".Keyword.Research" class="filter-checkers">
              <label>Keyword Research</label>
            </div>
            <div class="checkbox">
              <input type="checkbox" value=".Technical.SEO" class="filter-checkers">
                    ...
                    <?php if( have_rows('webinars_repeater') ): ?>
                     ...
                     <?php while( have_rows('webinars_repeater') ): the_row(); ?>
                        <?php                         
                         ...
                         ?>
						 <div class="mix <?php echo $value[0].' '.$value[1].' '.$value[2].' '.$value[3].' '.$value[4].' '.$value[5].' '.$value[6];?>"  data-bound="">
                        ...
                        <ul class="author-list">
                            ...
                            <li class="author-date">Head of SEO at <a href="<?php the_sub_field('head_of_seo')?>/" target="_blank"><span><?php the_sub_field('head_of_seo')?></span></a></li>
                            <li class="head-of-seo"><?php the_sub_field('date')?></li>
                            <li class="author-by author-category">Category: <span><?php the_sub_field('category')?></span></li>
                        </ul>
                        <div class="webinars-description">
                            <?php the_sub_field('webinars_description')?>
                            <div class="register-button-web"><a rel="nofollow" href="<?php the_sub_field('register_button_link')?>" target="_blank">REGISTER</a></div>
                        </div>
                        </div>    
                    </div>   
...
$( document ).ready(function() {
  ...
  if ($(this).is(':checked')) {
      var abc= $('.filter-checkers:checked').val();
      console.log(abc);
   if($(".mix").css("display") == "inline-block" ) {
