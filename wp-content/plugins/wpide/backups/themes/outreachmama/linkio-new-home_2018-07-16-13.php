<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6aef9f043d98"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/linkio-new-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/linkio-new-home_2018-07-16-13.php") )  ) ){
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        ...
        <div class="row">
            ...
            <div class="video-section">
                <div class="video-container">
                    <iframe src="<?php the_field('section_1_video')?>?rel=0&amp;controls=0&amp;showinfo=0"" 	height="274px"	width="489px"></iframe>
                </div>    
            </div>    
    ...
    <div class="row-750">
        <?php
        echo do_shortcode('[custom-twitter-feeds screenname=jeremygallas showheader=false]');
        ?>
        </div>
    </div>
