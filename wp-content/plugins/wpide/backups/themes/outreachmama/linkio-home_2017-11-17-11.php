<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "40e1c3a3c58d01e2586aae14625c4a21424b0e7bdb"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/linkio-home.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/linkio-home_2017-11-17-11.php") )  ) ){
...
<div id="primary" class="content-area common-inner">
 <main id="main" class="site-main" role="main">
    ...
    <h2>What People are Saying</h2>
        <div class="testimonials"><?php echo do_shortcode('[testimonial_rotator id="5831" format="list" limit="3"]'); ?></div>
    </div>
    </div>
    ...
    <div class="row">
        <div class="f-width"><?php the_field('add_title_tab_7'); ?><a href="<?php the_field('add_button_link_tab_7'); ?>">Try Linkio for Free</a></div>
    </div>
    </div>
