<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "e180d0b304a84fabf1c4649547ddc9c945a0dc05e8"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-conference.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-conference_2017-12-07-13.php") )  ) ){
                ...
                <?php if( have_rows('speakers') ): ?>
                 ...
                 <?php while( have_rows('speakers') ): the_row(); 
                  ...
                  <h3 class="speaker-title"><?php echo $speakername; ?></h3>        
                   ...
                   <p class="link"> <?php echo $speakerlink; ?></p>
                  </li>
