<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "25c67326c4a0b48238af035723f9ac88839d59db90"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-webinars.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-webinars_2019-01-30-11.php") )  ) ){
        ...
        <div class="webinars-content-area">
            ...
            <div class="resource-left">
                <div class="resource-half-left tags categories">
                  ...
                  <div class="resource-check"><input rel="category-six" type="checkbox" value="1" name="test" id="f-option6" class="all-2"><label for="f-option6"> Content Marketing</label></div>
                  <div class="resource-check"><input rel="category-six" type="checkbox" value="1" name="test" id="f-option6" class="all-2"><label for="f-option6"> Link Building</label></div>
                  <div class="resource-check"><input rel="category-six" type="checkbox" value="1" name="test" id="f-option6" class="all-2"><label for="f-option6"> Keyword Research</label></div>
                  <div class="resource-check"><input rel="category-six" type="checkbox" value="1" name="test" id="f-option6" class="all-2"><label for="f-option6"> Technical SEO</label></div>
                </div>
