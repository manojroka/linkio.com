<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "e180d0b304a84fabf1c4649547ddc9c9212e453be7"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/linkio-manage-backlink.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/linkio-manage-backlink_2017-12-16-09.php") )  ) ){
    ...
    <div class="section-3" style="background-image:url('<?php the_field('background-image'); ?>')">
       ...
       <div class="backlink-management-list">
           <div class="content-1-2">
                <div class="image-overlay  animated fadeInUp delay2 duration1 eds-on-scroll ">
