<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "e180d0b304a84fabf1c4649547ddc9c9247dc46a83"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/pricing-temp.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/pricing-temp_2018-03-01-10.php") )  ) ){
...
<div id="primary" class="content-area common-inner2">
 ...
 <div class="row-1100">
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" data-toggle="tooltip" href="#menu">Starter</a></li>
    <li><a data-toggle="tab" data-toggle="tooltip" href="#menu">Standard</a></li>
    <li><a data-toggle="tab" data-toggle="tooltip" href="#menu">Pro</a></li>
  </ul>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
        ...
        <p class="timmer">Price Increase in 30 Days</p>
        <div id="countup">
