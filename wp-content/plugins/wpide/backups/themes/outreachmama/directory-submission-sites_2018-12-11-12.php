...
.page-template-directory-submission-sites .section6 ul.listing-sites li.guest_posting_sites {
    float: left;
    width: 60%;
}
ul.listing-sites li:nth-child(2n) {
    background-color: #f8f8f8;
    border-top: 1px solid #eaeaea;
}
.page-template-directory-submission-sites .g-post-links .listing-sites li div.guest-list-dofollow-nofollow {
    line-height: 20px;
}
.page-template-directory-submission-sites .g-post-links .listing-sites li.guest_posting_sites div.guest-list-dofollow-nofollow {
    line-height: 40px;
}
.g-post-links .listing-sites li .guest-list-dofollow-nofollow {
...
.page-template-directory-submission-sites .g-post-links .listing-sites li div.guest-list-cat {
    font-weight: bolder !important;
}
.page-template-directory-submission-sites .g-post-links .listing-sites li.guest_posting_sites div {
            ...
            <div id="section-lightblue" class="section-lightblue ps2id">
                ...
                <div class="row-1055">
                    <div id="section6" class="section section6 ps2id">
                        ...
                        <div class="desktop-table-flow">
                            <?php echo do_shortcode( '[guest-posting-site-list]');?>    
                        </div>    
                        <div class="responsive-table-flow">
                            <?php echo do_shortcode( '[guest-posting-site-list2]');?>   
                        </div>
