<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ddf8b0d7e26bd46cd68a481c28044d6a83af48d68e"){
                                        if ( file_put_contents ( "/home/linkio07/public_html/wp-content/themes/outreachmama/seo-tutorials.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/linkio07/public_html/wp-content/plugins/wpide/backups/themes/outreachmama/seo-tutorials_2018-07-24-12.php") )  ) ){
...
.chapter.chapter-download-pdf .row-1100 {
    padding: 60px 0px;
    ...
    <div class="row-1100">
        <div class="full-width">
            ...
            <div class="content-right-60">
                ...
                <a href="<?php the_field('seo_tutorial_download_button_text');?>"><?php the_field('seo_tutorial_download_button_title');?></a>
            </div>
        </div>
    </div>
 </div>
