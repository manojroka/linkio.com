            ...
            <div class="overview-config">
                ...
                <div class="overview-content">
	                ...
	                <form id="epkb-wpml-enabled-config">
		                ...
		                <!--  KB NAME and other global settings -->
		                <div class="callout callout_default">
			                <h4>WPML (Beta for testing only)</h4>
			                <div class="row">
				                <div class="config-col-2">					                <?php
			                ...
			                <div class="row">
				                <div class="config-col-12">
					                <a href="https://www.echoknowledgebase.com/documentation/setup-wpml-for-knowledge-base/" target="_blank"><?php _e( 'WPL Setup for Knowledge Base documentation', 'echo-knowledge-base' ); ?></a>
