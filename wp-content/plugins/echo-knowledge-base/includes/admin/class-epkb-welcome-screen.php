...
class EPKB_Welcome_Screen {
	...
	private function show_what_is_new() {   ?>
       ...
       <!-- <div class="eckb-whats-new">
		...
		<div class="row">
			<div class="col-12">
				<h4>4.4.3, Feb 20, 2019</h4>
				<ul>
					<li>Fix: WPML settings affected after saving KB configuration</li>
				</ul>
				<h4>4.4.2, Feb 18, 2019</h4>
				<ul>
					<li>Updates: adjusting configuration for add-ons</li>
					<li>Fix: Minor issues</li>
				</ul>
				<h4>4.4.1, Dec 26, 2018</h4>
				<ul>
					<li>Fix: PHP issue with upper case Self:: reference</li>
					<li>* Fix: Minor issues</li>
				</ul>
				<h4>4.4.0, Dec 25, 2018</h4>
				<ul>
					<li>Update: Preparation for FAQ feature</li>
					<li>Fix: compatibility with Gutenberg</li>
					<li>Fix: Minor issues</li>
				</ul>
