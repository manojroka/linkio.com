(function () {var spp;(function () { if (!spp || !spp.requirejs) {
if (!spp) { spp = {}; } else { require = spp; }
/**
...
spp.requirejs = requirejs;spp.require = require;spp.define = define;
}
}());
spp.define("../vendor/almond", function(){});
...
(function( $ ) {
	...
	// Shows the correct set of options based on whether email signup is enabled
	...
	// Shows the correct set of embed options for the email signup CTA (Constant Contact or other)
