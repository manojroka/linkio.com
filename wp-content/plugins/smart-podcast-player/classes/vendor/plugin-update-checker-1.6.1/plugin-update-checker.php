...
if ( !class_exists('PluginUpdateChecker_1_6_for_SmartPodcastPlayer') ):
 ...
 * @access public
 */
class PluginUpdateChecker_1_6_for_SmartPodcastPlayer {
	...
	public function requestInfo($queryArgs = array()){
		...
		if ( !is_wp_error($result) && isset($result['response']['code']) && ($result['response']['code'] == 200) && !empty($result['body']) ){
			$pluginInfo = PluginInfo_1_6_for_SmartPodcastPlayer::fromJson($result['body'], $this->debugMode);
	...
	public function requestUpdate(){
		...
		return PluginUpdate_1_6_for_SmartPodcastPlayer::fromPluginInfo($pluginInfo);
	}
	...
	public function getUpdateState() {
		...
		if ( !empty($state) && isset($state->update) && is_object($state->update) ){
			$state->update = PluginUpdate_1_6_for_SmartPodcastPlayer::fromObject($state->update);
		}
		return $state;
	}
...
if ( !class_exists('PluginInfo_1_6_for_SmartPodcastPlayer') ):
 ...
 * @access public
 */
class PluginInfo_1_6_for_SmartPodcastPlayer {
...
if ( !class_exists('PluginUpdate_1_6_for_SmartPodcastPlayer') ):
 ...
 * @access public
 */
class PluginUpdate_1_6_for_SmartPodcastPlayer {
	public $id = 0;
	public $slug;
	public $version;
	public $homepage;
	...
	public static function fromJson($json, $triggerErrors = false){
		...
		$pluginInfo = PluginInfo_1_6_for_SmartPodcastPlayer::fromJson($json, $triggerErrors);
		if ( $pluginInfo != null ) {
...
if ( !class_exists('PucFactory_for_SmartPodcastPlayer') ):
 ...
 */
class PucFactory_for_SmartPodcastPlayer {
	...
	public static function buildUpdateChecker($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '') {
		$class = self::getLatestClassVersion('PluginUpdateChecker_for_SmartPodcastPlayer');
...
PucFactory_for_SmartPodcastPlayer::addVersion('PluginUpdateChecker_for_SmartPodcastPlayer', 'PluginUpdateChecker_1_6_for_SmartPodcastPlayer', '1.6');
PucFactory_for_SmartPodcastPlayer::addVersion('PluginUpdate_for_SmartPodcastPlayer', 'PluginUpdate_1_6_for_SmartPodcastPlayer', '1.6');
PucFactory_for_SmartPodcastPlayer::addVersion('PluginInfo_for_SmartPodcastPlayer', 'PluginInfo_1_6_for_SmartPodcastPlayer', '1.6');
 ...
 */
if ( !class_exists('PluginUpdateChecker_for_SmartPodcastPlayer') ) {
	class PluginUpdateChecker_for_SmartPodcastPlayer extends PluginUpdateChecker_1_6_for_SmartPodcastPlayer { }
}

if ( !class_exists('PluginUpdate_for_SmartPodcastPlayer') ) {
	class PluginUpdate_for_SmartPodcastPlayer extends PluginUpdate_1_6_for_SmartPodcastPlayer {}
}

if ( !class_exists('PluginInfo_for_SmartPodcastPlayer') ) {
	class PluginInfo_for_SmartPodcastPlayer extends PluginInfo_1_6_for_SmartPodcastPlayer {}
}
