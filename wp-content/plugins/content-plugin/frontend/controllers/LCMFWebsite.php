...
class LCMFWebsite extends LCMfrontend{
    
    function detail() {
        $detail = $this->lcmf_model->get_website_detail_by_id($this->id);
...
//                $lcm_refferer_url = str_replace('newitemform=website', '', $lcm_refferer_url);
