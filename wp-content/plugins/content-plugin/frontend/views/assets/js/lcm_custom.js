...
function showPopup(whichpopup) {
    ...
    jQuery('.lcm-item-popup-background').show().css({'height': docHeight});
...
jQuery('#lcm_ajax_item_form').submit(function (event) {

    var lcm_item_submit_btn = document.getElementById('lcm_item_submit_btn');
    tinyMCE.triggerSave();
    var formData = new FormData(document.getElementById('lcm_ajax_item_form'));
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            if (result.status == true) {
                ...
                jQuery('.lcm_js_item_submit_error').empty();
                jQuery('.lcm_js_item_submit_error').append(result.last_error);
...
jQuery(document).ready(function () {
    ...
    jQuery('.lcm_popup_close').click(function (event) {
        event.preventDefault();
        jQuery('.lcm-item-popup').hide();
        jQuery('.lcm-item-popup-background').hide();
    });
