<?php
/**
 * Template Name: Learn Seo Template
 *
...
<div class="h1-title"><h1>Answers to Your Most Burning SEO Questions</h1></div>
<div class="h2-title"><h2>Ask a Question</h2></div>
<div class="subscribe"><?php if (function_exists('tve_leads_form_display')) { tve_leads_form_display(1697, 1700); } ?></div>
</div>

<div class="row-1015 blog">
	<div id="primary" class="content-area">
	<div class="case-study"><p>Latest Q&A</p></div>
