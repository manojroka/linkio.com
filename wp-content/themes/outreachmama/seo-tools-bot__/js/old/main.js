...
function showResults() {
	...
	if(seoFilters.sort == 'name:asc') {
		// Show/hide the filtered tools
		alert('quickRender');
		quickRender();
	} else {
		// Generate+Inject full Html structure
		alert('fullRender');
		fullRender(seoToolsResults);
	}
	$('#loader').hide();
}
...
function fullRender(seoToolsResults) {
	var seoToolsHtml = '';
	...
	replaceHtml('seo-tools-results', seoToolsHtml); // document.getElementById('seo-tools-results').innerHTML = seoToolsHtml;
