...
<title>Anchor Text Generator | Anchor Text Suggestion Tool | Linkio</title>
...
<?php
	...
	$current_ats_path 	= $current_theme_path 	. '/ats-tool';
	$current_style_path	= $current_ats_path 	. '/css/style.css';
?>

<link rel="stylesheet" type="text/css" href="<?php echo $current_theme_uri ?>/ats-tool/css/fonts.css?302">
<link rel="stylesheet" type="text/css" href="<?php echo $current_theme_uri ?>/ats-tool/css/style.css?<?php echo filemtime( $current_style_path ); ?>">
...
<?php
	...
	require_once('ats-tool/ats-tool.php');
?>
