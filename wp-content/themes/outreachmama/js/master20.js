jQuery(document).ready(function ($) {
    ...
    window.onload = function () {
        ...
        upTime('april,26,2018,11:15:00'); // ****** Change this line!
    }
    function upTime(countTo) {
        var now = new Date();
        var utc = new Date(now.getTime() + now.getTimezoneOffset() * 6000);
        countTo = new Date(countTo);
        difference = (countTo - utc);
        ...
        if(document.getElementById('days') != null){
            document.getElementById('days').nodeValue = days;
        }
        if(document.getElementById('hours') != null){
            document.getElementById('hours').nodeValue = hours;
        }
        if(document.getElementById('minutes') != null){
            document.getElementById('minutes').nodeValue = minutes;
        }
        if(document.getElementById('days') != null){
            document.getElementById('secs').nodeValue = secs;
        }
        
        
//        document.getElementById('days').nodeValue = days;
//        document.getElementById('hours').nodeValue = hours;
//        document.getElementById('minutes').nodeValue = mins;
//        document.getElementById('seconds').nodeValue = secs;
